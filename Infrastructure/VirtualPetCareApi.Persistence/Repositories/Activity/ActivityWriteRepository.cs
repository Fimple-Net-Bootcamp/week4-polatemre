...
{
    internal class ActivityWriteRepository : WriteRepository<Activity>, IActivityWriteRepository
    {
        public ActivityWriteRepository(VirtualPetCareApiDbContext context) : base(context)
        {
        }
    }
}
